...
const TAX_RATE_PERCENTAGE = 0;      // Tax removed from calculation
 ...
 * applying an 80% profit margin, advisor fixed cost, staff fixed cost, and optional loyalty discount.
 * Formula: (service cost + service cost * 80/100 + advisor fixed cost + staff fixed cost) - loyaltyDiscount
...
export const calculateCustomerPaymentWithMargin = (serviceCostTotal, loyaltyDiscountPercentage = 0) => {
  ...
  // Subtotal before loyalty discount (no tax)
